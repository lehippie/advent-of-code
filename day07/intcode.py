...
class Intcode():
    ...
    def _process_parameters(self, nb_param):
        ...
        values = [self.memory[a] for a in addresses]
    ...
    def _instr_add(self):
        ...
        self.memory[result] = self.memory[a] + self.memory[b]
        self.pointer += 4
    ...
    def _instr_input(self):
        ...
        if not self.inputs:
            ...
            self.memory[address] = self.inputs.pop(0)
            self.pointer += 2
    ...
    def _instr_output(self):
        ...
        """
        value = self.memory[self._process_parameters(1)]
    ...
    def _instr_less_than(self):
        ...
        """
        a, b, result = self._process_parameters(3)
        self.memory[result] = int(self.memory[a] < self.memory[b])
        self.pointer += 4
